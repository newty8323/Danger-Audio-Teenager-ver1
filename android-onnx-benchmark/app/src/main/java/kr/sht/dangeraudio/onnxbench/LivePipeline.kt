...
class LivePipeline(context: Context) : AutoCloseable {
    data class Result(
        ...
        val whisperNoSpeechProbability: Float,
        val whisperAverageLogProbability: Double,
    ...
    fun process(window16k: FloatArray, serverUrl: String?): Result {
        ...
        val result = Result(
            ...
            whisperNoSpeechProbability = asr.noSpeechProbability,
            whisperAverageLogProbability = asr.averageLogProbability,
